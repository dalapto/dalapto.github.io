...
function Home() {
	const pages = [
		{ name: 'About Me', route: 'about', img: '../src/img/tile/about.png' },
		{ name: 'Projects', route: 'projects', img: '../src/img/tile/m2.png' },
		{ name: 'Blog', route: 'blog', img: '../src/img/tile/blog.png' },
	];
	const tooltips = [
		...
		{ text: 'GitHub Pages', link: 'https://pages.github.com/', img: 'src/img/logo/gh.png' },
	];
