...
const premisePanel: JsonImageTextPanel = {
	...
	imageMaxWidth: '35%',
	content: [
		'I wanted a practical project, so I chose to make an Android app.',
		'',
...
const testingPanel: JsonImageTextPanel = {
	...
	content: [
		...
		"I gave testers various goals to do, like 'view a message' or 'make a post'.",
		'',
		`I spoke as little as possible, so I could observe their ${userJourney} more naturally.`,
		'I then asked questions based on the goals, for them to score on a scale of 1 to 5.',
		'',
