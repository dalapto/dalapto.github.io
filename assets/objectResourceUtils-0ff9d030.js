...
vuv0 = uv0;
vuvRegion = uvRegion;
}`);default:Ye(e.textureCoordinateType);case Y.None:return void t.vertex.code.add(s`void forwardTextureCoordinates() {}`);case Y.COUNT:return}}(function(t){t[t.None=0]="None",t[t.Default=1]="Default",t[t.Atlas=2]="Atlas",t[t.Compressed=3]="Compressed",t[t.COUNT=4]="COUNT"})(Y||(Y={}));function Ln(t){t.fragment.code.add(s`vec4 textureAtlasLookup(sampler2D tex, vec2 textureCoordinates, vec4 atlasRegion) {
...
}`)}function Es(t){t.uniforms.add(new te("screenSizePerspectiveAlignment",e=>Ms(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function Ms(t){return oe(Rs,t.parameters.divisor,t.parameters.offset,t.parameters.minPixelSize,t.paddingPixelsOverride)}const Rs=zt();function ui(t,e){const r=t.vertex;e.hasVerticalOffset?(Ps(r),e.hasScreenSizePerspective&&(t.include(Os),Es(r),gt(t.vertex,e)),r.code.add(s`
...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=ea(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-9f029b77.js"),["assets/SSAOBlur.glsl-9f029b77.js","assets/index-425e7585.js","assets/index-8aa619e0.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-3edda6fa.js","assets/vec32-fe78be5a.js","assets/DefaultMaterial_COLOR_GAMMA-5fef37f1.js","assets/quat-2896e496.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-a4539411.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-b284b250.js","assets/InterleavedLayout-cf2e5224.js","assets/types-1305598a.js","assets/sphere-9006632a.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-118f5bb2.js","assets/Texture-f032536a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-58fa13cd.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-bf06f758.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function el(t){const e=t.camera.projectionMatrix;return e[11]===0?oe(no,2/(t.camera.fullWidth*e[0]),2/(t.camera.fullHeight*e[5]),(1+e[12])/e[0],(1+e[13])/e[5]):oe(no,-2/(t.camera.fullWidth*e[0]),-2/(t.camera.fullHeight*e[5]),(1-e[8])/e[0],(1-e[9])/e[5])}const no=zt();function xi(t){return t.camera.projectionMatrix[11]===0?Lt(so,0,1):Lt(so,1,0)}const so=_o(),lo=16;function tl(){const t=new kt,e=t.fragment;return t.include(mi),e.include(Or),t.include(Ys),e.uniforms.add(new ee("radius",(r,o)=>Ti(o.camera))),e.code.add(s`vec3 sphere[16];
void fillSphere() {
...
return fallOffFunction(vv, vn, 0.1);
}`),e.uniforms.add(new Ce("nearFar",(r,o)=>o.camera.nearFar),new Z("normalMap",r=>r.normalTexture),new Z("depthMap",r=>r.depthTexture),new Ce("zScale",(r,o)=>xi(o)),new ee("projScale",r=>r.projScale),new Z("rnm",r=>r.noiseTexture),new Ce("rnmScale",(r,o)=>Lt(co,o.camera.fullWidth/r.noiseTexture.descriptor.width,o.camera.fullHeight/r.noiseTexture.descriptor.height)),new ee("intensity",r=>r.intensity),new Ce("screenSize",(r,o)=>Lt(co,o.camera.fullWidth,o.camera.fullHeight))),e.code.add(s`
    void main(void) {
      fillSphere();
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=_o(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new Cr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};ol.shader=new Wt(rl,()=>xt(()=>import("./SSAO.glsl-84163ade.js"),["assets/SSAO.glsl-84163ade.js","assets/index-425e7585.js","assets/index-8aa619e0.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-3edda6fa.js","assets/vec32-fe78be5a.js","assets/DefaultMaterial_COLOR_GAMMA-5fef37f1.js","assets/quat-2896e496.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-a4539411.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-b284b250.js","assets/InterleavedLayout-cf2e5224.js","assets/types-1305598a.js","assets/sphere-9006632a.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-118f5bb2.js","assets/Texture-f032536a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-58fa13cd.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-bf06f758.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
...
const float HALF_PI = 1.570796326794897;`)}function Rr(t,e){const r=t.fragment.code;t.include(bi),e.pbrMode!==L.Normal&&e.pbrMode!==L.Schematic&&e.pbrMode!==L.Terrain&&e.pbrMode!==L.TerrainWithWater||(r.add(s`float normalDistribution(float NdotH, float roughness)
{
...
return c2 * a004 + r.zw;
}`)),e.pbrMode!==L.Normal&&e.pbrMode!==L.Schematic||(t.include(nl),r.add(s`struct PBRShadingInfo
{
float NdotL;
float NdotV;
float NdotH;
...
return outColor;
}`))}let sl=class extends J{constructor(e,r){super(e,"bool",V.Pass,(o,i,a)=>o.setUniform1b(e,r(i,a)))}};const ll=.4;function Lr(t){t.constants.add("ambientBoostFactor","float",ll)}function Pr(t){t.uniforms.add(new ee("lightingGlobalFactor",(e,r)=>r.lighting.globalFactor))}function Si(t,e){const r=t.fragment;switch(t.include(Er,e),e.pbrMode!==L.Disabled&&t.include(Rr,e),t.include(al,e),t.include(bi),r.code.add(s`
    const float GAMMA_SRGB = 2.1;
    const float INV_GAMMA_SRGB = 0.4761904;
    ${e.pbrMode===L.Disabled?"":"const vec3 GROUND_REFLECTANCE = vec3(0.2);"}
  `),Lr(r),Pr(r),Mr(r),r.code.add(s`
...
}`),e.pbrMode){case L.Disabled:case L.WaterOnIntegratedMesh:case L.Water:t.include(ho),r.code.add(s`vec3 evaluateSceneLighting(vec3 normalWorld, vec3 albedo, float shadow, float ssao, vec3 additionalLight)
{
...
inputs.averageAmbientRadiance = ambientLightIrradianceComponent[1] * (1.0 + GROUND_REFLECTANCE[1]);`),r.code.add(s`
    ...
    `);break;case L.Terrain:case L.TerrainWithWater:t.include(ho),r.code.add(s`const float roughnessTerrain = 0.5;
...
return max(c.x, max(c.y, c.z));
  ...
  `)}function gl(t){const e=new kt,{vertex:r,fragment:o,varyings:i}=e;if(pt(r,t),e.include(Sr),i.add("vpos","vec3"),e.include(vt,t),e.include(si,t),e.include(ui,t),t.hasColorTextureTransform&&e.include(ul),t.output===y.Color||t.output===y.Alpha){t.hasNormalTextureTransform&&e.include(hl),t.hasEmissionTextureTransform&&e.include(ml),t.hasOcclusionTextureTransform&&e.include(fl),t.hasMetallicRoughnessTextureTransform&&e.include(pl),gt(r,t),e.include(Ht,t),e.include(ft,t);const a=t.normalType===B.Attribute||t.normalType===B.Compressed;a&&t.offsetBackfaces&&e.include(ti),e.include(Hs,t),e.include(Qo,t),t.instancedColor&&e.attributes.add(h.INSTANCECOLOR,"vec4"),i.add("vPositionLocal","vec3"),e.include(qe,t),e.include(ei,t),e.include(ci,t),e.include(di,t),r.uniforms.add(new te("externalColor",l=>l.externalColor)),i.add("vcolorExt","vec4"),t.hasMultipassTerrain&&i.add("depth","float");const n=t.hasModelTransformation;if(n){const l=Tt();r.uniforms.add(new ze("model",c=>c.modelTransformation??Ke)),r.uniforms.add(new pe("normalTransform",c=>(Rt(l,c.modelTransformation??Ke),l)))}r.code.add(s`
    ...
    `)),t.output===y.Color&&(e.include(Be,t),e.include(Si,t),e.include(Er,t),e.include(Ue,t),e.include(t.instancedDoublePrecision?Ai:yi,t),e.include(Nt,t),gt(e.fragment,t),Mr(o),Lr(o),Pr(o),o.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new Q("ambient",a=>a.ambient),new Q("diffuse",a=>a.diffuse),new ee("opacity",a=>a.opacity),new ee("layerOpacity",a=>a.layerOpacity)),t.hasColorTexture&&o.uniforms.add(new Z("tex",a=>a.texture)),e.include(zo,t),e.include(Rr,t),o.include(Dt),jt(o),o.code.add(s`
      void main() {
        discardBySlice(vpos);
        ${t.hasMultipassTerrain?s`terrainDepthTest(gl_FragCoord, depth);`:""}
        ${t.hasColorTexture?s`
